...
export const Login = () => {
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#020617] relative overflow-hidden px-4">
            ...
            <div className="max-w-md w-full space-y-10 p-12 bg-slate-900/40 backdrop-blur-3xl rounded-[2.5rem] shadow-2xl border border-slate-800 relative z-10">
                <div className="text-center space-y-3">
                    <h2 className="text-3xl font-black text-white tracking-tighter">Login</h2>
                    <p className="text-sm text-slate-400 font-medium tracking-tight italic">Welcome back! Please sign in.</p>
                </div>
                <LoginForm />
            </div>
        </div>
